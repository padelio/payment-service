...
<p>This repository will be used to manage payment services for padelio booking app in the microservices system.</p>
...
field-service
    ...
    L templates                      → Contains templates for generating things (such as invoices)
```
